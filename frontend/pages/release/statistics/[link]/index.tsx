    ...
    ;(async () => {
      const getCountries = async () => {
        const res = await axios.get(
          `https://api-metrika.yandex.net/stat/v1/data/bytime?filters=ym:pv:URL=='https://linkmusic.ru${router.pathname}'&id=${CounterID}&metrics=ym:s:visits&dimensions=ym:s:regionCountry&limit=6&group=${timeSorting}`,
          {
            headers: {
              Authorization:
        ...
        const formatCountries = async () => {
          ...
          setCountries(countriesArray.sort((a, b) => a.count - b.count))
        }
      ...
      const getCities = async () => {
        const res = await axios
          .get(
            `https://api-metrika.yandex.net/stat/v1/data/bytime?filters=ym:pv:URL=='https://linkmusic.ru${router.pathname}'&id=${CounterID}&metrics=ym:s:visits&dimensions=ym:s:regionCity&limit=6&group=${timeSorting}`,
            {
              headers: {
                Authorization:
                  "Bearer y0_AgAEA7qkbq8fAAowRQAAAADn2xuj326ugKWkSRmnGsBEA7S3W6eIfp0",
      ...
      const getGenders = async () => {
        const res = await axios
          .get(
            `https://api-metrika.yandex.net/stat/v1/data/bytime?filters=ym:pv:URL=='https://linkmusic.ru${router.pathname}'&metrics=ym:s:visits&dimensions=ym:s:gender&id=${CounterID}&group=${timeSorting}`,
            {
              headers: {
                Authorization:
                  "Bearer y0_AgAEA7qkbq8fAAowRQAAAADn2xuj326ugKWkSRmnGsBEA7S3W6eIfp0",
      ...
      const getAges = async () => {
        const res = await axios.get(
          `https://api-metrika.yandex.net/stat/v1/data/bytime?filters=ym:pv:URL=='https://linkmusic.ru${router.pathname}'&metrics=ym:s:visits&dimensions=ym:s:ageInterval&id=${CounterID}&group=${timeSorting}`,
          {
            headers: {
              Authorization:
                "Bearer y0_AgAEA7qkbq8fAAowRQAAAADn2xuj326ugKWkSRmnGsBEA7S3W6eIfp0",
      ...
      const getSocials = async () => {
        const res = await axios.get(
          `https://api-metrika.yandex.net/stat/v1/data/bytime?filters=ym:pv:URL=='https://linkmusic.ru${router.pathname}'&metrics=ym:s:visits&dimensions=ym:s:<attribution>SocialNetwork&id=${CounterID}&group=${timeSorting}`,
          {
            headers: {
              Authorization:
                "Bearer y0_AgAEA7qkbq8fAAowRQAAAADn2xuj326ugKWkSRmnGsBEA7S3W6eIfp0",
    ...
    <section className="block block-statistics block_first-on-page">
      ...
      <div className="content">
        ...
        <div className={style.statistics__tablets}>
          <div className={style.statistics__tablet}>
            ...
            <div className="statistics-tablet__main-content">
              <div className={style.statistics__tablet__row}>
                ...
                <div className={style.statistics__tablet__name}>Вконтакте</div>
              ...
              <div className={style.statistics__tablet__row}>
                ...
                <div className={style.statistics__tablet__name}>Instagram</div>
                <div className={style.statistics_tablet__number}>
                  {socials.inst}
                </div>
              </div>
              <div className={style.statistics__tablet__row}>
                ...
                <div className={style.statistics__tablet__name}>Facebook</div>
                <div className={style.statistics_tablet__number}>
                  {socials.fb}
                </div>
              </div>
              <div className={style.statistics__tablet__row}>
                ...
                <div className={style.statistics__tablet__name}>YouTube</div>
                <div className={style.statistics_tablet__number}>
                  {socials.yt}
                </div>
              </div>
          ...
          <div style={{ height: "50%" }} className={style.statistics__tablet}>
            <div className={style.statistics__tablet__title}>
              <p>Пол</p>
            </div>
          ...
          <div className={style.statistics__tablet}>
            ...
            <div className="statistics__tablet__main-content">
              ...
              <div className={style.statistics__tablet__row}>
                <div className={style.statistics__tablet__name}>55+ лет</div>
                <div className={style.statistics_tablet__number}>
                  {ages.a25}
                </div>
              </div>
